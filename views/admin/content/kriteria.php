                 ...
                 <div class="card">
                     ...
                     <form class="form-horizontal" action="aksi/?aksi=kriteria_save" id="form-add-upd">
                         ...
                         <div class="card-body card-block">
                             ...
                             <div class="row form-group">
                                 <div class="col col-md-3">
                                     <label for="nama" class=" form-control-label">Pertanyaan&nbsp;*</label>
                                 </div>
                                 <div class="col-12 col-md-9">
                                     <input type="text" id="nama" name="nama" class="form-control form-control-sm" placeholder="Masukkan Pertanyaan" />
                                     <small class="help-block form-text error"></small>
                                 </div>
                             </div>
                             <div class="row form-group">
